...
namespace TStack.MongoDB
{
    ...
    public class Database<T> // where T : IMongoEntity
    {
    ...
    //{
    //    internal static IMongoCollection<T> GetCollectionFromType<T>(Type type, MongoConnection mongoConnection)
    //    {
    //        var client = GetClient(mongoConnection);

    //        string collectionName = type.Name.ToLowerInvariant();

    //        var mongoDatabase = GetDataBaseFromClient(client, mongoConnection.Database);

    //        mongoDatabase.GetCollection<T>

    //        //.GetCollection<T>(collectionName);
    //        return collection;
    //    }

    //    internal static IMongoCollection<T> GetCollectionFromMongoConnection<T>(this T Entity, MongoConnection mongoConnection)
    //        where T : IMongoEntity
    //    {
    //        var client = GetClient(mongoConnection);

    //        var collection = GetDataBaseFromClient(client, mongoConnection.Database).GetCollection<T>(GetCollectionName(Entity));
    ...
    //    /// </summary>
    //    /// <returns>Returns the collection name for T.</returns>
    //    private static string GetCollectionName<T>(T Entity)
    //    {
    //        string collectionName;
